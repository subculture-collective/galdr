...
> **See also:** `playwright` (general CLI browser automation), `webapp-testing` (Playwright test scripts for local apps), `chrome-devtools` (DevTools MCP for debugging/profiling).
