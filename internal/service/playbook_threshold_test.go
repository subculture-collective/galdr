		...
		playbooks: []*repository.Playbook{
			{
				...
				TriggerConfig: map[string]any{
					playbookThresholdConfigThreshold: 40,
					playbookThresholdConfigDirection: playbookThresholdDirectionDropsBelow,
				},
			},
		},
	}
		...
		playbooks: []*repository.Playbook{
			{
				...
				TriggerType: repository.PlaybookTriggerScoreThreshold,
				TriggerConfig: map[string]any{
					playbookThresholdConfigThreshold: 80,
					playbookThresholdConfigDirection: playbookThresholdDirectionRisesAbove,
				},
			},
		},
	}
		...
		playbooks: []*repository.Playbook{
			{
				...
				TriggerConfig: map[string]any{
					playbookThresholdConfigThreshold:     40,
					playbookThresholdConfigDirection:     playbookThresholdDirectionDropsBelow,
					playbookThresholdConfigCooldownHours: 24,
				},
			},
		},
