...
func TestBenchmarkMigrationUpFileContainsTablesAndOptInFields(t *testing.T) {
	sql := readMigrationSQL(t, "../../migrations/000025_create_benchmarking.up.sql")
...
func TestBenchmarkMigrationDownFileDropsTablesAndOptInFields(t *testing.T) {
	sql := readMigrationSQL(t, "../../migrations/000025_create_benchmarking.down.sql")
...
func TestBenchmarkMigrationDoesNotOwnOrganizationIndustry(t *testing.T) {
	upSQL := readMigrationSQL(t, "../../migrations/000025_create_benchmarking.up.sql")
	downSQL := readMigrationSQL(t, "../../migrations/000025_create_benchmarking.down.sql")
